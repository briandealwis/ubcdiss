...
%% 
%% Should you be feeling brave and wish to use your platform's native
%% fonts, see the commented out bits below for XeTeX (or XeLaTeX).
%% This is not for the faint at heart.  And you should really be
...
%% subfigure: provides for including subfigures within a figure,
...
\date{April 2192}	% submission date
